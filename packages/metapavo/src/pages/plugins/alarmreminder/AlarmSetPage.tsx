...
export default function AlarmSetPage(props: any) {
  const [time, setTime] = React.useState(props.timestamp ? moment(props.timestamp) : moment());
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <AlarmSetFormWrap>
        ...
        <CirclePicker
          colors={["#416AFC", "#E14942", "#00D502", "#FA00F0", "#252525"]}
          onChange={handleColorChange}
        />
        <button className="submit-btn" type="button" onClick={onBtnClick}>
          Create Reminder
        </button>
      </AlarmSetFormWrap>
